...
import (
	...
	"github.com/lukehendrick/connectService/queuesummary"
...
func routes() *chi.Mux {
	...
	router.Route("/", func(r chi.Router) {
		...
		r.Mount("/queues-summary", queuesummary.Routes())
...
func main() {
	...
	log.Fatal(http.ListenAndServe(":9000", router)) // Note, the port is usually gotten from the environment.
}
